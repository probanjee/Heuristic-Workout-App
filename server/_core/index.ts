...
import { handleReminderCallback } from "../scheduled/reminders";
import { handleStreakAlertCallback } from "../scheduled/streaks";
...
async function startServer() {
  ...
  // Heartbeat callback boundary: intentionally disabled until deployment and activation approval.

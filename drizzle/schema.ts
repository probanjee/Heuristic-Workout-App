...
export const authChallenges = pgTable("auth_challenges", {
  ...
  channel: text("channel").$type<"phone" | "email">().notNull(),
  purpose: text("purpose").$type<"phone_login" | "email_verification" | "password_reset">().notNull(),
...
export const dailyWorkouts = pgTable("daily_workouts", {
  ...
  status: text("status").$type<"planned" | "in_progress" | "completed" | "skipped">().default("planned").notNull(),
